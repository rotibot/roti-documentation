...
| /stats  | Displays the current bot statistics             | `/stats`                |
...
|   /connectfour    | Engage in a game of Connect Four with your friends | `/connectfour [user]`              |
