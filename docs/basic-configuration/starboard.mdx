...
- `Right-click on the Message:` Locate the message that you wish to send to the starboard within the Discord chat.

- `Select "Apps":` After right-clicking on the message, a context menu will appear. From this menu, hover your cursor over the "Apps" option.

- `Click "Send to Starboard":` Once you've hovered over "Apps," a sub-menu should appear. In this sub-menu, click on the "Send to Starboard" option.
